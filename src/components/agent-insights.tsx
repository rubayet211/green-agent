    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 my-6">
      ...
      <div className="bg-slate-900/40 border border-slate-800/80 p-6 rounded-2xl shadow-md">
        <div className="flex items-center gap-3 border-b border-slate-800/80 pb-4 mb-4">
          ...
          <h3 className="font-bold text-slate-200">Context Analyzer Insight</h3>
        ...
        <div className="space-y-2.5">
          <h4 className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Identified focus risks:</h4>
      ...
      <div className="bg-slate-900/40 border border-slate-800/80 p-6 rounded-2xl shadow-md">
        <div className="flex items-center gap-3 border-b border-slate-800/80 pb-4 mb-4">
          ...
          <h3 className="font-bold text-slate-200">Carbon Estimator Insight</h3>
          <span className={`ml-auto text-[10px] uppercase font-bold tracking-widest px-2.5 py-0.5 rounded-full ${
        ...
        <div className="space-y-2.5">
          <h4 className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Main carbon drivers:</h4>
          <ul className="space-y-1.5">
